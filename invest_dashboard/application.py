...
class Dashboard(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        window_icon = pkg_resources.resource_filename('invest_dashboard.images',
    ...
    def file_menu(self):
        ...
        self.open_action.setStatusTip('Open a file into Dashboard.')
    ...
    def tool_bar_items(self):
        ...
        open_icon = pkg_resources.resource_filename('invest_dashboard.images',
...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        help_icon = pkg_resources.resource_filename('invest_dashboard.images',
                                                    'ic_help_black_48dp_1x.png')
        self.setWindowIcon(QIcon(help_icon))
        self.resize(300, 200)

        author = QLabel('Mauricio Vieira')
        author.setAlignment(Qt.AlignCenter)

        icons = QLabel('Material design icons created by Google')
        icons.setAlignment(Qt.AlignCenter)

        github = QLabel('GitHub: mauriciovieira')
